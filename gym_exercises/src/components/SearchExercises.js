...
const SearchExercises = ({ setExercises, bodyPart, setBodyPart }) => {
  ...
  const handleSearch = async (e) => {
    if(search) {
      ...
      setSearch(''); setExercises(searchedExercises)
    }
  }
  ...
  return (
    <Stack alignItems='center' mt='37px' justifyContent='center' p='20px'>
      ...
      <Box position='relative' mb='72px'>
        <TextField sx={{ input:{fontWeight:'700', border:'none', borderRadius:'4px'}, width:{lg:'800px', xs:'350px'}, backgroundColor:'white', borderRadius:'40px' }} 
